...
const Admin = () => {
    ...
    const deleteUser = (id)=>{
        fetch(`http://localhost:3002/api/execs/delete/${id}`, {
            method: 'DELETE'
        })
        .then(response => {
    ...
    const handleCreateUser = async (e) => {
        ...
        const response = await fetch("http://localhost:3002/api/execs/create",{
            method: "PUT",
            body: formData,
        })
    ...
    const handleEdit = async (e) => {
        ...
        const response = await fetch(`http://localhost:3002/api/execs/put/${selectedId}`,{
            method: "PUT",
    ...
    useEffect(() => {
        ...
        const handleAdmin = async () =>{
            const response = await fetch("http://localhost:3002/api/execs/get")
            const newUsers = await response.json()
            await setExecs(newUsers)
        ...
        return(
            <div className="admin-all">
                <div className="all-forms">
                    ...
                    {currentForm === "create" && (
                        <form className="create-form" onSubmit={handleCreateUser}>
                            ...
                            <div className="create-buttons">
                                <button className="create-create" type="submit">Create Exec</button>
                    ...
                    {currentForm == "none" && (<button className='create-user-button' onClick={() => handleCreateClick()}>Create Exec</button>)}
