...
function About() {
return (
  <div className="About" style={{width: "100%", background: '#212121'}}>
      ...
      <div style={{display: 'flex',  background: '#212121',position: 'relative', justifyContent: "flex-end",flexDirection: 'row' }}>
        <div> {/** vertical container. */}
          <div className="WhatSOurGoal"
            style={{ textAlign: 'right', color: 'white', fontSize: 60, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>
              What's our Goal?
          </div>
          <div className="lorem2" 
            style={{width: 776,  textAlign: 'right', color: 'white', fontSize: 32, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>
  ...
  <div className="Controller" style={{width: 218.51, height: 193.50,  }}>
